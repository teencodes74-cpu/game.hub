...
- Multiple playable game modes (maze, shooter, puzzle, penalty, platformer, memory, snake, tetris-like, flappy-style, breakout-style)
- Each game includes:
  - `index.html`
  - `style.css`
  - `script.js`
...
- Shared runtime (`/games/_shared/engine.js`) centralizes gameplay logic so many games can reuse and extend mode implementations.
